...
if (Subjects == null || Subjects.trim().isEmpty()) {
    assert false : "Subjects wajib diisi minimal 1 huruf atau angka"
}
...
if (hobbyValue == null || hobbyValue.isEmpty()) {
    assert false : "Hobby wajib dipilih salah satu (music/sports/reading)"
} else if (hobbyValue == 'music') {
    ...
    assert false : "Hobby tidak valid: " + hobbyValue
}
